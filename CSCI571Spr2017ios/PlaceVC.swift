...
class PlaceVC: UIViewController, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        Alamofire.request("http://csci571spr2017ypios-env.us-west-2.elasticbeanstalk.com/wHW92ag5.php?q="+queryStr+"&type=place").responseJSON{ response in
            self.fetched = true
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if(numRow > 0 && searchData.count>0)
        {
            ...
            let favList = UserDefaults.standard.dictionary(forKey: "place")
            if(favList == nil)
            {
